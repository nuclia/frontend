...
describe('PostHogService', () => {
  ...
  describe('init', () => {
    it('should do nothing when no posthog config', () => {
      service = new PostHogService({ hasPosthog: () => false } as BackendConfigurationService);
      service.init('mail');
      expect(posthog.identify).not.toHaveBeenCalled();
    });

    it('should call posthog.identify and set people email when posthog config', () => {
      service = new PostHogService({ hasPosthog: () => true } as BackendConfigurationService);
      service.init('mail');
  ...
  describe('reset', () => {
    ...
    it('should call postHog.reset when posthog config', () => {
      service = new PostHogService({ hasPosthog: () => true } as BackendConfigurationService);
      service.reset();
  ...
  describe('logEvent', () => {
    ...
    it('should call postHog.capture when posthog config', () => {
      service = new PostHogService({ hasPosthog: () => true } as BackendConfigurationService);
