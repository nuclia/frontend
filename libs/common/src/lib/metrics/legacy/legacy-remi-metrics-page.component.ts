...
import { LegacyRemiMetricsService as RemiMetricsService, RemiPeriods } from './legacy-remi-metrics.service';
...
@Component({
  ...
  templateUrl: './legacy-remi-metrics-page.component.html',
  styleUrl: './legacy-remi-metrics-page.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LegacyRemiMetricsPageComponent implements AfterViewInit, OnInit, OnDestroy {
