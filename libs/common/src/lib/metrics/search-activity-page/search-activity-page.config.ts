...
export const SEARCH_ACTIVITY_COLUMNS: MetricsColumnDef[] = [
  ...
  {
    key: 'min_score_semantic',
    label: 'activity.column.min-score-semantic',
    value: (item: ActivityLogItem) => item.min_score_semantic ?? null,
    width: '120px',
    group: 'retrieval',
  },
  {
  ...
  {
    key: 'min_score_bm25',
    label: 'activity.column.min-score-bm25',
    value: (item: ActivityLogItem) => item.min_score_bm25 ?? null,
    width: '120px',
    defaultHidden: true,
    group: 'retrieval',
  },
  ...
  {
    key: 'resources_count',
    label: 'activity.column.resources-count',
    value: (item: ActivityLogItem) => item.resources_count ?? null,
    width: '130px',
    defaultHidden: true,
    group: 'retrieval',
  },
  {
    key: 'retrieval_time',
    label: 'activity.column.retrieval-time',
    value: (item: ActivityLogItem) => item.retrieval_time ?? null,
    width: '120px',
    defaultHidden: true,
    group: 'retrieval',
  },
  {
    key: 'vectorset',
    label: 'activity.column.vectorset',
    value: (item: ActivityLogItem) => item.vectorset ?? null,
    width: '140px',
    defaultHidden: true,
    group: 'retrieval',
    searchable: true,
...
export const SEARCH_ACTIVITY_SIDEBAR_FIELDS: MetricsSidebarField[] = [
  {
    key: 'retrieval_rephrased_question',
    label: 'activity.column.retrieval-rephrased-question',
    value: (item: ActivityLogItem) => item.retrieval_rephrased_question ?? null,
    expandable: true,
    group: 'retrieval',
  },
];
