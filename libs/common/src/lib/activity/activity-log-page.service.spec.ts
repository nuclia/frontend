...
const MOCK_DEFS: ActivityColumnDef[] = [
...
describe('ActivityLogPageService', () => {
  let service: ActivityLogPageService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        ActivityLogPageService,
        DatePipe,
        { provide: TranslateService, useValue: { instant: (key: string) => key } },
      ],
    });
    service = TestBed.inject(ActivityLogPageService);
  });
  ...
  describe('getCellValue()', () => {
    const DEFS_WITH_NULL: ActivityColumnDef[] = [
      { key: 'question', label: 'activity.question', value: (item) => (item as any).question },
