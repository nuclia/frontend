...
describe('ProcessingActivityPageService', () => {
  let service: ProcessingActivityPageService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ProcessingActivityPageService);
  });
  ...
  describe('availableMonths signal', () => {
    ...
    it('unions months from all three event types and deduplicates, sorted descending', () => {
      ...
      const freshService = TestBed.inject(ProcessingActivityPageService);
