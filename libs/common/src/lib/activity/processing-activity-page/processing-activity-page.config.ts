...
export const PROCESSING_ACTIVITY_COLUMNS: ActivityColumnDef[] = [
  ...
  { key: 'client_type', label: 'activity.column.client-type', value: (item: ActivityLogItem) => item.client_type ?? null, width: '140px', group: 'query' },
  ...
  { key: 'id', label: 'activity.column.id', value: (item: ActivityLogItem) => item.id ?? null, width: '100px', defaultHidden: true, group: 'processing' },
