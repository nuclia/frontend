...
const dropdownFadeIn = animation(
  [
    style({
      opacity: 0,
      transform: 'scale(0.8)',
...
const dropdownFadeOut = animation(
...
export const stfAnimations = [
  trigger('animate', [transition('void => *', [useAnimation(customAnimation)])]),

  trigger('dropdown', [
    transition(':enter', [useAnimation(dropdownFadeIn)]),
    transition(':leave', [useAnimation(dropdownFadeOut)])
  ]),

  trigger('dropdownTopRight', [
    transition(':enter', [useAnimation(dropdownFadeIn, {
  ...
  trigger('dropdownTopLeft', [
    transition(':enter', [useAnimation(dropdownFadeIn, {
      params: { origin: 'top left' }
    })]),
    transition(':leave', [useAnimation(dropdownFadeOut)])
  ]),
