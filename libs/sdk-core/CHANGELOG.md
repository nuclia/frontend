...
- Make `slug` optional when creating an account, letting the backend generate it
...
- Support adding and removing semantic models
- Add support for extract strategies
- Support additional task actions:
  - Delete data generated by a tasks
