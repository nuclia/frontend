...
files, and knowledge embedded in .github/skills/ and .github/agents/.
...
```
.github/skills/knowledge-sync/SKILL.md
```
...
2. **Run staleness check** — execute `.github/skills/knowledge-sync/scripts/check-staleness.sh`
...
4. **For every AGENTS.md update**, use the `agents-review` skill
   (`.github/skills/agents-review/SKILL.md`) to ensure the updated file meets quality criteria.
...
| Updating skill files (`.github/skills/`)     | ✅ inline              | —                           |
