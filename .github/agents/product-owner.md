...
```
.github/skills/product-knowledge/SKILL.md
```
...
All paths are relative to `.github/skills/product-knowledge/`.
...
Compare with `.github/skills/product-knowledge/meta.json`. If stale, ask the user to run a
