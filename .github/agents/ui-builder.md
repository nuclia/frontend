...
1. Read `.github/skills/angular-patterns/SKILL.md` — follow every
   rule there precisely. These are non-negotiable conventions enforced across the codebase.

2. Read `.github/skills/design-system/SKILL.md` — use the correct
   nsi-_ / pa-_ components rather than writing custom SCSS from scratch. Always prefer
   SisModalService and SisToastService over the raw Pastanaga equivalents.

3. Read `.github/skills/i18n-patterns/SKILL.md` — every user-visible
