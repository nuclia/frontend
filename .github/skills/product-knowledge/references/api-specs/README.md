...
YAML files are stored in this directory: `.github/skills/product-knowledge/references/api-specs/`

Version metadata is tracked in: `.github/skills/product-knowledge/meta.json`
...
python3 -c "import json; d=json.load(open('.github/skills/product-knowledge/meta.json')); print(d['api_specs']['global']['etag'])"
```

If ETags differ, re-download:

```bash
curl -o .github/skills/product-knowledge/references/api-specs/global.yaml \
