...
#
# Usage: .github/skills/knowledge-sync/scripts/install-hooks.sh
...
SCRIPT_PATH="${REPO_ROOT}/.github/skills/knowledge-sync/scripts/check-staleness.sh"
...
cat > "$HOOK_PATH" << 'HOOK'
#!/usr/bin/env bash
# post-merge hook — installed by .github/skills/knowledge-sync/scripts/install-hooks.sh
# Runs knowledge staleness check after git pull / git merge

REPO_ROOT="$(git rev-parse --show-toplevel)"
SCRIPT="${REPO_ROOT}/.github/skills/knowledge-sync/scripts/check-staleness.sh"
