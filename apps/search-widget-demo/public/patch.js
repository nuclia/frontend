// code from `redefine-custom-elements` package
'use strict';
...
function getObservedAttributesOffset(originalDefinition, instancedDefinition) {
  ...
  return new Set(
    [...originalDefinition.observedAttributes].filter((x) => !instancedDefinition.observedAttributes.has(x)),
  );
}
...
function createPivotingClass(originalDefinition, tagName) {
  var _a;
  return (
    (_a = class PivotCtor extends NativeHTMLElement {
